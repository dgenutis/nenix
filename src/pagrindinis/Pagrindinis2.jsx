import "./Pagrindinis2.css";

const Pagrindinis2 = () => {
  return (
    <>
      <div className="paslaugos">
        <div className="paslaugosPavadinimas">
        <h2>Mūsų Paslaugos</h2>
        <h1>Paslaugos, kurios turės didelį poveikį jūsų verslui</h1>
        ...
        <div className="paslaugu-turinys">
          ...
          <div className="turinys2">
            ...
            <p>
              ...
              grafinio dizaino paslaugomis, pritaikytomis kūrybiškam jūsų prekės
              ženklo kilimui ir dėmesio pritraukimui.
            </p>
          </div>
